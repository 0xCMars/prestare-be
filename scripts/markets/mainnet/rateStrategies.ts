...
// DAI WETH
export const rateStrategyBClass: IInterestRateStrategyParams = {
    name: "rateStrategyBClass",
    optimalUtilizationRate: BigNumber.from(0.8 * 100).mul(oneRay).div(100).toString(),
    baseVariableBorrowRate: BigNumber.from(0.05 * 100).mul(oneRay).div(100).toString(),
    variableRateSlope1: BigNumber.from(0.04 * 100).mul(oneRay).div(100).toString(),
    variableRateSlope2: BigNumber.from(1 * 100).mul(oneRay).div(100).toString(),
};

export const rateStrategyCClass: IInterestRateStrategyParams = {
    name: "rateStrategyCClass",
    optimalUtilizationRate: BigNumber.from(0.8 * 100).mul(oneRay).div(100).toString(),
    baseVariableBorrowRate: BigNumber.from(0.1 * 100).mul(oneRay).div(100).toString(),
    variableRateSlope1: BigNumber.from(0.04 * 100).mul(oneRay).div(100).toString(),
    variableRateSlope2: BigNumber.from(1 * 100).mul(oneRay).div(100).toString(),
};
